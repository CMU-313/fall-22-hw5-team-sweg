...
angular
  .module("docs")
  .controller(
    "DocumentViewWorkflow",
    function ($scope, $stateParams, Restangular, $translate, $dialog) {
      /**
       * Load routes.
       */
      ...
      $scope.cancelWorkflow = function () {
        const title = $translate.instant(
          "document.view.workflow.cancel_workflow_title"
        );
        const msg = $translate.instant(
          "document.view.workflow.cancel_workflow_message"
        );
        const btns = [
