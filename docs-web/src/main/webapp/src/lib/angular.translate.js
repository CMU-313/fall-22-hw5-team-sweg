      ...
      function ($injector, $log) {
        ...
        return {
          ...
          sanitize: function (value, mode, strategy, context) {
            ...
            const selectedStrategies = angular.isArray(strategy)
              ? strategy
              : [strategy];
  ...
  function $translate(
    ...
    this.$get = [
      ...
      function ($log, $injector, $rootScope, $q) {
        let Storage;
        const defaultInterpolator = $injector.get(
        ...
        var $translate = function (
          ...
          const promiseToWaitFor = (function () {
            let promise =
              langPromises[uses] || langPromises[$preferredLanguage];
        ...
        var getFallbackTranslationInstant = function (
          ...
          let result;
          const translationTable = $translationTable[langKey];
         ...
         * absent
         */
        const translateByHandler = function (
          translationId,
          interpolateParams,
          defaultTranslationText,
          sanitizeStrategy
        ...
        var resolveForFallbackLanguage = function (
          ...
          if (fallbackLanguageIndex < $fallbackLanguage.length) {
            ...
            if (defaultTranslationText) {
              ...
              const missingTranslationHandlerTranslation = translateByHandler(
                translationId,
                interpolateParams,
                defaultTranslationText
              );
         ...
         */
        const fallbackTranslation = function (
          translationId,
          interpolateParams,
          Interpolator,
          defaultTranslationText,
         ...
         * @return {String} translation
         */
        const fallbackTranslationInstant = function (
          translationId,
          interpolateParams,
          Interpolator,
          sanitizeStrategy
        ...
        var determineTranslation = function (
          ...
          const Interpolator = interpolationId
          ...
          if (
            ...
            if (translation.substr(0, 2) === "@:") {
              ...
              //
              let resolvedTranslation = Interpolator.interpolate(
                translation,
                interpolateParams,
                "service",
                sanitizeStrategy,
        ...
        $translate.refresh = function (langKey) {
          ...
          if (!langKey) {
            ...
            const languagesToReload =
              ($fallbackLanguage && $fallbackLanguage.slice()) || [];
            if ($uses && languagesToReload.indexOf($uses) === -1) {
              languagesToReload.push($uses);
            }
            $q.all(languagesToReload.map(loadNewData)).then(
              deferred.resolve,
              deferred.reject
            );
    ...
    return {
      ...
      compile: function (tElement, tAttr) {
        ...
        return function linkFn(scope, iElement, iAttr) {
          ...
          const initInterpolationParams = function (
            interpolateParams,
            iAttr,
            tAttr
          ) {
            ...
            if (translateValueExist) {
              for (const attr in tAttr) {
                if (
                  ...
                  const attributeName =
                    lowercase(attr.substr(14, 1)) + attr.substr(15);
          ...
          if (translateValueExist) {
            const observeValueAttribute = function (attrName) {
              iAttr.$observe(attrName, function (value) {
                const attributeName =
                  lowercase(attrName.substr(14, 1)) + attrName.substr(15);
    ...
    return {
      compile: function (tElement) {
        ...
        return function linkFn(scope, iElement, iAttr) {
          ...
          const iRemoveCloak = removeCloak.bind(this, iElement);
          const iApplyCloak = applyCloak.bind(this, iElement);
 ...
 */
  ...
  function translateFilterFactory($parse, $translate) {
    ...
    const translateFilter = function (
      translationId,
      interpolateParams,
      interpolation,
      forceLanguage
  ...
  function $translateStaticFilesLoader($q, $http) {
    ...
    return function (options) {
      ...
      const load = function (file) {
        ...
        let fileUrl = [file.prefix, options.key, file.suffix].join("");
