...
(function( factory ) {
  ...
  $.widget = function( name, base, prototype ) {
    let existingConstructor; let constructor; let basePrototype;
  ...
  $.Widget.prototype = {
    ...
    _setOptionClasses: function( value ) {
      let classKey; let elements; let currentElements;
