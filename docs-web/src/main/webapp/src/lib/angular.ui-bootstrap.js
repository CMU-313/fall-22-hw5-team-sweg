      ...
      return {
        beforeAddClass: function (element, className, done) {
          if (className === "active") {
            ...
            const removeClassFn = removeClass.bind(
              this,
              element,
    ...
    function ($log, $locale, dateFilter, orderByFilter, filterFilter) {
          ...
          if (angular.isNumber(literalIdx)) {
            if (format.charAt(i) === "'") {
              if (i + 1 >= format.length || format.charAt(i + 1) !== "'") {
                formatters.push(
                  constructLiteralFormatter(format, literalIdx, i)
                );
                literalIdx = null;
              }
      ...
      this.parse = function (input, format, baseDate) {
        ...
        if (results && results.length) {
          ...
          const datesetter = tzOffset
            ? Date.prototype.setUTCFullYear
            : Date.prototype.setFullYear;
          const timesetter = tzOffset
...
angular
    ...
    function (
      ...
      this.refreshView = function () {
        if (this.element) {
          ...
          let date = ngModelCtrl.$viewValue
    ...
    function (scope, $element, dateFilter) {
      ...
      this.handleKeyDown = function (key, evt) {
        ...
        if (key === "left") {
          ...
          const month =
            this.activeDate.getMonth() + (key === "pageup" ? -1 : 1);
  ...
  .controller("UibYearpickerController", [
    ...
    function (scope, $element, dateFilter) {
      ...
      this._refreshView = function () {
        const years = new Array(range);
        let date;

        for (
          let i = 0, start = getStartingYear(this.activeDate.getFullYear());
          i < range;
          i++
        ) {
          date = new Date(this.activeDate);
      ...
      return {
        ...
        scrollbarWidth: function (isBody) {
          if (isBody) {
            if (angular.isUndefined(BODY_SCROLLBAR_WIDTH)) {
              ...
              BODY_SCROLLBAR_WIDTH =
                $window.innerWidth - bodyElem[0].clientWidth;
          ...
          if (angular.isUndefined(SCROLLBAR_WIDTH)) {
            const scrollElem = angular.element(
        ...
        viewportOffset: function (elem, useDocument, includePadding) {
          ...
          const offsetParent = useDocument
          ...
          if (includePadding) {
            ...
            offsetBCR.bottom -= this.parseStyle(
              offsetParentStyle.paddingBottom
            );
        ...
        positionElements: function (
          ...
          const hostElemPos = appendToBody
          ...
          if (placement[2]) {
            ...
            placement[1] =
              ...
              adjustedSize.height - hostElemPos.height <= viewportOffset.top
                ...
                ? "top"
                : placement[1] === "left" &&
                  adjustedSize.width - hostElemPos.width >
            ...
            if (placement[1] === "center") {
              if (PLACEMENT_REGEX.vertical.test(placement[0])) {
                ...
                const yOverflow =
                  hostElemPos.height / 2 - adjustedSize.height / 2;
                if (
        ...
        positionArrow: function (elem, placement) {
          ...
          const innerElem = elem.querySelector(
          ...
          const isTooltip = angular
            .element(innerElem)
            .hasClass("tooltip-inner");

          const arrowElem = isTooltip
...
angular
  ...
  .controller("UibDatepickerPopupController", [
    ...
    function (
      ...
      let dateFormat;
      let closeOnDateSelection;
      let appendToBody;
      let onOpenFocus;
      let datepickerPopupTemplateUrl;
      let datepickerTemplateUrl;
      let popupEl;
      let datepickerEl;
      let scrollParentEl;
      let ngModel;
      ...
      this.init = function (_ngModel_) {
        ...
        if (datepickerPopupConfig.html5Types[$attrs.type]) {
          ...
          $attrs.$observe("uibDatepickerPopup", function (value, oldValue) {
            const newDateFormat =
              value || datepickerPopupConfig.datepickerPopup;
      ...
      $scope.dateSelection = function (dt) {
        ...
        const date = $scope.date
          ...
          : null; // Setting to NULL is necessary for form validators to function
        $element.val(date);
          ...
          if (!$scope.disabled) {
            $timeout(
              function () {
                ...
                const placement = $attrs.popupPlacement
      ...
      function positionPopup() {
        if ($scope.isOpen) {
          const dpElement = angular.element(
            $popup[0].querySelector(".uib-datepicker-popup")
          );
          const placement = $attrs.popupPlacement
            ? $attrs.popupPlacement
            : datepickerPopupConfig.placement;
          const position = $position.positionElements(
            $element,
            dpElement,
            placement,
            appendToBody
  ...
  .service("uibDropdownService", [
    ...
    function ($document, $rootScope, $$multiMap) {
      ...
      this.isOnlyOpen = function (dropdownScope, appendTo) {
        ...
        if (openedDropdowns) {
          const openDropdown = openedDropdowns.reduce(function (
            toClose,
            dropdown
          ) {
      ...
      this.close = function (dropdownScope, element, appendTo) {
        ...
        const openedDropdowns = openedContainers.get(appendTo);
        if (openedDropdowns) {
          const dropdownToClose = openedDropdowns.reduce(function (
            toClose,
            dropdown
          ) {
            if (dropdown.scope === dropdownScope) {
      ...
      this.keybindFilter = function (evt) {
        ...
        const dropdownElement = openScope.getDropdownElement();
        const toggleElement = openScope.getToggleElement();
        const dropdownElementTargeted =
          dropdownElement && dropdownElement[0].contains(evt.target);
        const toggleElementTargeted =
  ...
  .controller("UibDropdownController", [
    ...
    function (
      ...
      scope.$watch("isOpen", function (isOpen, wasOpen) {
        ...
        if (appendTo && self.dropdownMenu) {
          const pos = $position.positionElements(
            $element,
            self.dropdownMenu,
            "bottom-left",
            true
...
angular
  ...
  .provider("$uibResolve", function () {
    ...
    this.$get = [
      ...
      "$q",
      function ($injector, $q) {
        const resolver = resolve.resolver
  ...
  .factory("$uibModalStack", [
    ...
    function (
      ...
      const ARIA_HIDDEN_ATTRIBUTE_NAME =
        ...
        removeAfterAnimate(
          ...
          function () {
            const modalBodyClass =
              modalWindow.openedClass || OPENED_MODAL_CLASS;
      ...
      $modalStack.open = function (modalInstance, modal) {
        ...
        topModalIndex = previousTopOpenedModal
          ...
          : 0;
        const angularDomEl = angular.element(
        ...
        function applyAriaHidden(el) {
          ...
          getSiblings(el).forEach(function (sibling) {
            const elemIsAlreadyHidden =
              sibling.getAttribute("aria-hidden") === "true";
            let ariaHiddenCount = parseInt(
      ...
      function unhideBackgroundElements() {
        Array.prototype.forEach.call(
          ...
          function (hiddenEl) {
            const ariaHiddenCount = parseInt(
...
angular
  ...
  .controller("UibPaginationController", [
    ...
    function ($scope, $attrs, $parse, uibPaging, uibPaginationConfig) {
      ...
      const forceEllipses = angular.isDefined($attrs.forceEllipses)
        ? $scope.$parent.$eval($attrs.forceEllipses)
        : uibPaginationConfig.forceEllipses;
      const boundaryLinkNumbers = angular.isDefined($attrs.boundaryLinkNumbers)
        ? $scope.$parent.$eval($attrs.boundaryLinkNumbers)
        : uibPaginationConfig.boundaryLinkNumbers;
      const pageLabel = angular.isDefined($attrs.pageLabel)
        ? function (idx) {
          ...
          if (endPage < totalPages) {
            ...
            if (boundaryLinkNumbers) {
              if (endPage === totalPages - 2) {
                // need to replace ellipsis when the buttons would be sequential
                const secondToLastPageLink = makePage(
                  totalPages - 1,
                  totalPages - 1,
                  false
                );
            ...
            compile: function (tElem, tAttrs) {
              ...
              return function link(scope, element, attrs, tooltipCtrl) {
                ...
                const isOpenParse = angular.isDefined(attrs[prefix + "IsOpen"])
                  ...
                  : false;
                const contentParse = options.useContentExp
                  ? $parse(attrs[ttType])
                  : false;
                const observers = [];
                let lastPlacement;
                  ...
                  if (!positionTimeout) {
                    positionTimeout = $timeout(
                      function () {
                        ...
                        const initialHeight = angular.isDefined(
                        ...
                        adjustmentTimeout = $timeout(
                          function () {
                            const currentHeight = angular.isDefined(
                              tooltip.offsetHeight
                            )
                              ? tooltip.offsetHeight
                              : tooltip.prop("offsetHeight");
...
angular
  ...
  .controller("UibProgressController", [
    ...
    function ($scope, $attrs, progressConfig) {
      const self = this;
      const animate = angular.isDefined($attrs.animate)
  ...
  .controller("UibRatingController", [
    ...
    function ($scope, $attrs, ratingConfig) {
      ...
      this.init = function (ngModelCtrl_) {
        ...
        const tmpTitles = angular.isDefined($attrs.titles)
...
angular
  ...
  .controller("UibTimepickerController", [
    ...
    function (
      ...
      let hoursModelCtrl;
      let minutesModelCtrl;
      let secondsModelCtrl;
      ...
      const padHours = angular.isDefined($attrs.padHours)
      ...
      this.init = function (ngModelCtrl_, inputs) {
        ...
        const arrowkeys = angular.isDefined($attrs.arrowkeys)
...
angular
  ...
  .controller("UibTypeaheadController", [
    ...
    function (
      ...
      const focusFirst =
        originalScope.$eval(attrs.typeaheadFocusFirst) !== false;
      ...
      // WAI-ARIA
      const popupId =
        "typeahead-" + scope.$id + "-" + Math.floor(Math.random() * 10000);
      element.attr({
      ...
      this.init = function (_modelCtrl) {
        ...
        scope.debounceUpdate = $parse(ngModelOptions.getOption("debounce"))(
          originalScope
        );
  ...
  function ($rootScope, $uibModal, $sce) {
    ...
    return {
      ...
      messageBox: function (title, message, buttons, resultFn) {
        const scope = angular.extend($rootScope.$new(false), {
          title: title,
