        ...
        function (require, module, exports) {
          ...
          module.exports = function (window, less, options) {
            function errorHTML(e, rootHref) {
              const id =
                "less-error-message:" + utils.extractId(rootHref || "");
              const template =
            ...
            function removeErrorHTML(path) {
              const node = window.document.getElementById(
                "less-error-message:" + utils.extractId(path)
              );
              if (node) {
      ...
      6: [
        function (require, module, exports) {
          ...
          module.exports = function (options, logger) {
            ...
            FileManager.prototype.alwaysMakePathsAbsolute =
              function alwaysMakePathsAbsolute() {
                return true;
              };
            ...
            FileManager.prototype.doXHR = function doXHR(
              url,
              type,
              callback,
              errback
            ...
            FileManager.prototype.loadFile = function loadFile(
              filename,
              currentDirectory,
              options,
              environment,
              ...
              const hrefParts = this.extractUrlParts(
                filename,
              ...
              if (options.useFileCache && fileCache[href]) {
                try {
                  ...
                  callback({
                    filename: href,
                    message:
                      "Error loading file " + href + " error was " + e.message,
                  });
                }
                return;
              }
        ...
        function (require, module, exports) {
          ...
          module.exports = function (window, options) {
            ...
            const cache = (less.cache =
              options.cache ||
              require("./cache")(window, options, less.logger));
            ...
            function postProcessCSS(styles) {
              ...
              if (
                ...
                typeof options.postProcessor === "function"
              ) {
            ...
            less.refresh = function (reload, modifyVars, clearFileCache) {
              ...
              return new Promise(function (resolve, reject) {
                ...
                if (remainingSheets === 0) {
                  ...
                  loadStyleSheets(
                    function (e, css, _, sheet, webInfo) {
                      if (e) {
                        errors.add(e, e.href || sheet.href);
                        reject(e);
                        return;
 ...
 */
      ...
      15: [
        function (require, module, exports) {
          ...
          abstractFileManager.prototype.tryAppendLessExtension = function (
            path
          ) {
          ...
          abstractFileManager.prototype.pathDiff = function pathDiff(
            url,
            baseUrl
          ) {
          ...
          abstractFileManager.prototype.extractUrlParts =
        ...
        function (require, module, exports) {
          ...
          for (const f in mathFunctions) {
            if (mathFunctions.hasOwnProperty(f)) {
              mathFunctions[f] = mathHelper._math.bind(
                null,
                Math[f],
                mathFunctions[f]
              );
          ...
          functionRegistry.addMultiple({
            ...
            pow: function (x, y) {
              if (typeof x === "number" && typeof y === "number") {
                ...
                !(x instanceof Dimension) ||
                !(y instanceof Dimension)
              ) {
                throw {
                  type: "Argument",
          ...
          module.exports = function (environment, fileManagers) {
            ...
            const less = {
              ...
              SourceMapOutput: (SourceMapOutput =
                require("./source-map-output")(environment)),
              SourceMapBuilder: (SourceMapBuilder =
                require("./source-map-builder")(SourceMapOutput, environment)),
              ParseTree: (ParseTree =
                require("./parse-tree")(SourceMapBuilder)),
              ImportManager: (ImportManager =
                require("./import-manager")(environment)),
            ...
            ParseTree.prototype.toCSS = function (options) {
              ...
              if (options.pluginManager) {
                const postProcessors =
                  options.pluginManager.getPostProcessors();
              ...
              switch (cc) {
                ...
                case 47: // /, check for comment
                  ...
                  if (cc2 == 47) {
                    ...
                    // /*, find */
                    lastMultiComment = currentChunkStartIndex =
                      chunkerCurrentIndex;
                    for (
                      chunkerCurrentIndex = chunkerCurrentIndex + 2;
            ...
            return {
              ...
              parse: function (str, callback, additionalData) {
                ...
                if (context.pluginManager) {
                  const preProcessors =
                    context.pluginManager.getPreProcessors();
              ...
              parsers: (parsers = {
                    ...
                    while (true) {
                      ...
                      if (val && val instanceof tree.Variable) {
                        if (parserInput.$char(":")) {
                          ...
                          value =
                            parsers.detachedRuleset() || parsers.expression();
                ...
                rule: function (tryAnonymous) {
                  ...
                  if (name) {
                    ...
                    if (!value) {
                      ...
                      merge =
                        !isVariable && name.length > 1 && name.pop().value;
                ...
                atomicCondition: function () {
                  ...
                  a =
                    this.addition() || entities.keyword() || entities.quoted();
                  if (a) {
                    if (parserInput.$char(">")) {
                      if (parserInput.$char("=")) {
                        op = ">=";
                ...
                ruleProperty: function () {
                  ...
                  const simpleProperty = parserInput.$re(
                    /^([_a-zA-Z0-9-]+)\s*:/
                  );
                  if (simpleProperty) {
      ...
      57: [
        function (require, module, exports) {
          ...
          Directive.prototype.outputRuleset = function (
            context,
            output,
            rules
          ) {
      ...
      61: [
        function (require, module, exports) {
          ...
          Import.prototype.evalPath = function (context) {
            ...
            const rootpath =
              this.currentFileInfo && this.currentFileInfo.rootpath;
      ...
      64: [
        function (require, module, exports) {
          ...
          JsEvalNode.prototype.evaluateJavaScript = function (
            expression,
            context
          ) {
            let result;
            ...
            if (
              context.javascriptEnabled !== undefined &&
              !context.javascriptEnabled
            ) {
              throw {
      ...
      67: [
        function (require, module, exports) {
          ...
          MixinCall.prototype._setVisibilityToReplacement = function (
            replacement
          ) {
            let i;
            let rule;
      ...
      68: [
        function (require, module, exports) {
          ...
          const Definition = function (
            ...
            this.selectors = [
              new Selector([
                new Element(null, name, this.index, this.currentFileInfo),
              ]),
            ];
            this.params = params;
          ...
          Definition.prototype.evalParams = function (
            context,
            mixinEnv,
            args,
            evaldArguments
                ...
                if ((name = arg && arg.name)) {
                  ...
                  for (j = 0; j < params.length; j++) {
                    if (!evaldArguments[j] && name === params[j].name) {
                      ...
                      frame.prependRule(
                        new Rule(name, arg.value.eval(context))
                      );
                      isNamedFound = true;
                      break;
                    }
      ...
      76: [
        function (require, module, exports) {
          ...
          Ruleset.prototype.genCSS = function (context, output) {
            ...
            const tabSetStr = context.compress
              ? ""
              : Array(context.tabLevel).join("  ");
            let sep;
          ...
          Ruleset.prototype.joinSelectors = function (
            paths,
            context,
            selectors
          ) {
      ...
      77: [
        function (require, module, exports) {
          ...
          Selector.prototype.eval = function (context) {
            const evaldCondition =
              this.condition && this.condition.eval(context);
            let elements = this.elements;
          ...
          ProcessExtendsVisitor.prototype = {
            ...
            isElementValuesEqual: function (elementValue1, elementValue2) {
              ...
              if (elementValue1 instanceof tree.Attribute) {
                ...
                elementValue1 =
                  elementValue1.value.value || elementValue1.value;
                elementValue2 =
                  elementValue2.value.value || elementValue2.value;
                return elementValue1 === elementValue2;
              }
              ...
              if (elementValue1 instanceof tree.Selector) {
                if (
                  ...
                  elementValue1.elements.length !==
                    elementValue2.elements.length
                ) {
                  return false;
                }
            ...
            extendSelector: function (
              ...
              path = path.map(function (currentValue) {
                ...
                const derived = currentValue.createDerived(
          ...
          ImportVisitor.prototype = {
            ...
            processImportNode: function (importNode, context, importParent) {
              ...
              if (evaldImportNode && (!evaldImportNode.css || inlineCSS)) {
                ...
                const tryAppendLessExtension =
                  evaldImportNode.css === undefined;
                ...
                const sequencedOnImported =
                  this._sequencer.addImport(onImported);
