        ...
        return {
          ...
          link: function (scope, element, attrs, ngModel) {
            ...
            function getPlaceholderExcludesludes(element, placeholder) {
              ...
              const notCssSelector = opts["ui-model-items"].replace(
                /[^,]*>/g,
                ""
              );
              const excludes = element.find(
                '[class="' +
            ...
            function wireUp() {
              ...
              callbacks.start = function (e, ui) {
                if (opts["ui-floating"] === "auto") {
                  ...
                  const sortableWidgetInstance = getSortableWidgetInstance(
              ...
              callbacks.activate = function (e, ui) {
                ...
                if (placeholder && placeholder.length) {
                  const excludes = getPlaceholderExcludesludes(
                    element,
                    placeholder
                  );
              ...
              callbacks.update = function (e, ui) {
                ...
                if (!ui.item.sortable.received) {
                  ...
                  const droptargetContext =
                    ui.item.sortable._getElementContext(droptarget);
                ...
                const elementContext =
                  ui.item.sortable._getElementContext(element);
              ...
              callbacks.stop = function (e, ui) {
                ...
                if (wasMoved && !ui.item.sortable.received) {
                  ...
                  const sortingHelper = getSortingHelper(
                    element,
                    ui,
                    savedNodes
                  );
              ...
              scope.$watchCollection(
                ...
                function (newVal, oldVal) {
                  // ensure that the jquery-ui-sortable widget instance
                  // is still bound to the directive's element
                  const sortableWidgetInstance =
                    getSortableWidgetInstance(element);
                  if (!!sortableWidgetInstance) {
                    const optsDiff = patchUISortableOptions(
                      newVal,
                      oldVal,
                      sortableWidgetInstance
                    );
