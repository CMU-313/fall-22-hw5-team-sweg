 ...
 */ (function (root, factory) {
  ...
  restangular.provider("Restangular", function () {
    ...
    Configurer.init = function (object, config) {
      ...
      config.absoluteUrl = _.isUndefined(config.absoluteUrl)
        ? true
        : config.absoluteUrl;
      ...
      config.encodeIds = _.isUndefined(config.encodeIds)
        ? true
        : config.encodeIds;
      ...
      object.setMethodOverriders = function (values) {
        const overriders = _.extend([], values);
      ...
      object.setRestangularFields = function (resFields) {
        config.restangularFields = _.extend(
      ...
      config.useCannonicalId = _.isUndefined(config.useCannonicalId)
        ? false
        : config.useCannonicalId;
      ...
      config.getCannonicalIdFromElem = function (elem) {
        ...
        const actualId = config.isValidId(cannonicalId)
          ? cannonicalId
      ...
      config.defaultResponseInterceptor = function (
        data /* , operation, what, url, response, deferred */
      ) {
        return data;
      };

      config.responseExtractor = function (
        data,
        operation,
        what,
        url,
      ...
      config.defaultInterceptor = function (
        element,
        operation,
        path,
        url,
      ...
      config.fullRequestInterceptor = function (
        element,
        operation,
        path,
        url,
        ...
        const defaultRequest = config.defaultInterceptor(
          element,
          operation,
          path,
          url,
      ...
      object.addRequestInterceptor = function (interceptor) {
        config.requestInterceptors.push(function (
          elem,
          operation,
          path,
          url,
      ...
      config.onBeforeElemRestangularized =
        config.onBeforeElemRestangularized ||
        function (elem) {
          return elem;
        };
      ...
      object.addElementTransformer = function (type, secondArg, thirdArg) {
        ...
        const transformerFn = function (coll, elem) {
      ...
      config.transformElem = function (
        ...
        if (
          ...
          !elem[config.restangularFields.fromServer]
        ) {
          return elem;
        }
        ...
        const matchTransformers = config.matchTransformers;
        ...
        return config.onElemRestangularized(
          changedElem,
          isCollection,
          route,
          Restangular
      ...
      config.transformLocalElements = _.isUndefined(
        config.transformLocalElements
      )
        ? false
        : config.transformLocalElements;
      ...
      config.fullResponse = _.isUndefined(config.fullResponse)
        ? false
        : config.fullResponse;
      ...
      BaseCreator.prototype.resource = function (
        current,
        $http,
        localHttpConfig,
        callHeaders,
        ...
        if (
          ...
          url.indexOf(
            this.config.suffix,
            url.length - this.config.suffix.length
          ) === -1 &&
            ...
            if (elemSelfLink) {
              ...
              if (elem[__this.config.restangularFields.restangularCollection]) {
                ...
                if (config.isValidId(elemId) && !elem.singleOne) {
                  elemUrl +=
                    "/" +
                    (__this.config.encodeIds
                      ? encodeURIComponent(elemId)
                      : elemId);
                }
              }
            }
      ...
      function ($http, $q) {
        function createServiceForConfiguration(config) {
          ...
          function restangularizeBase(
            ...
            elem[config.restangularFields.getRestangularUrl] = _.bind(
              urlHandler.fetchUrl,
              urlHandler,
              elem
            );
            elem[config.restangularFields.getRequestedUrl] = _.bind(
              urlHandler.fetchRequestedUrl,
              urlHandler,
              elem
            );
            elem[config.restangularFields.addRestangularMethod] = _.bind(
              addRestangularMethodFunction,
              elem
            );
            elem[config.restangularFields.clone] = _.bind(
              copyRestangularizedElement,
              elem,
              elem
            );
            elem[config.restangularFields.reqParams] = _.isEmpty(reqParams)
              ? null
              : reqParams;
            elem[config.restangularFields.withHttpConfig] = _.bind(
              withHttpConfig,
              elem
            );
            elem[config.restangularFields.plain] = _.bind(
              stripRestangular,
              elem,
              elem
            );
            ...
            elem[config.restangularFields.several] = _.bind(
              several,
              elem,
              elem
            );
            ...
            if (parent && config.shouldSaveParent(route)) {
              ...
              const restangularFieldsForParent = _.union(
                _.values(
                  _.pick(config.restangularFields, [
                    "route",
                    "singleOne",
                    "parentResource",
                  ])
              ...
              const parentResource = _.pick(parent, restangularFieldsForParent);
          ...
          function one(parent, route, id, singleOne) {
            ...
            config.setFieldToElem(
              config.restangularFields.singleOne,
              elem,
              singleOne
            );
          ...
          function restangularizePromise(promise, isCollection, valueToFill) {
            ...
            promise[config.restangularFields.restangularCollection] =
              isCollection;
            if (isCollection) {
          ...
          function promiseCall(method) {
            ...
            return restangularizePromise(
              deferred.promise,
              this[config.restangularFields.restangularCollection],
              filledValue
            );
          }
          ...
          function stripRestangular(elem) {
            if (_.isArray(elem)) {
              ...
              _.each(elem, function (value) {
                array.push(
                  config.isRestangularized(value)
                    ? stripRestangular(value)
                    : value
                );
              });
              return array;
              ...
              return _.omit(
                elem,
                _.values(_.omit(config.restangularFields, "id"))
              );
            }
          }

          function addCustomOperation(elem) {
            elem[config.restangularFields.customOperation] = _.bind(
              customFunction,
              elem
            );
            ...
            _.each(["put", "patch", "post"], function (name) {
              requestMethods[name] = function (
                ...
                return _.bind(customFunction, this)(
                  operation,
                  path,
                  params,
                  headers,
            ...
            _.each(requestMethods, function (requestFunc, name) {
              ...
              _.each(["do", "custom"], function (alias) {
                elem[alias + name.toUpperCase()] = _.bind(
                  requestFunc,
                  elem,
                  callOperation
                );
            ...
            elem[config.restangularFields.customGETLIST] = _.bind(
              fetchFunction,
              elem
            );
            elem[config.restangularFields.doGETLIST] =
              elem[config.restangularFields.customGETLIST];
          }

          function copyRestangularizedElement(element) {
            const copiedElement = angular.copy(element);
          ...
          function restangularizeElem(
            ...
            const elem = config.onBeforeElemRestangularized(
              element,
              false,
              route
            );

            const localElem = restangularizeBase(
              parent,
              elem,
              route,
              reqParams,
            ...
            if (config.useCannonicalId) {
              localElem[config.restangularFields.cannonicalId] =
                config.getIdFromElem(localElem);
            }
            ...
            localElem[config.restangularFields.get] = _.bind(
              getFunction,
              localElem
            );
            localElem[config.restangularFields.getList] = _.bind(
              fetchFunction,
              localElem
            );
            localElem[config.restangularFields.put] = _.bind(
              putFunction,
              localElem
            );
            localElem[config.restangularFields.post] = _.bind(
              postFunction,
              localElem
            );
            localElem[config.restangularFields.remove] = _.bind(
              deleteFunction,
              localElem
            );
            localElem[config.restangularFields.head] = _.bind(
              headFunction,
              localElem
            );
            localElem[config.restangularFields.trace] = _.bind(
              traceFunction,
              localElem
            );
            localElem[config.restangularFields.options] = _.bind(
              optionsFunction,
              localElem
            );
            localElem[config.restangularFields.patch] = _.bind(
              patchFunction,
              localElem
            );
          ...
          function restangularizeCollection(
            parent,
            element,
            route,
            fromServer,
            ...
            localElem[config.restangularFields.putElement] = _.bind(
              putElementFunction,
              localElem
            );
            localElem[config.restangularFields.options] = _.bind(
          ...
          function restangularizeCollectionAndElements(
            ...
            const collection = restangularizeCollection(
              parent,
              element,
              route,
              fromServer
          ...
          function putElementFunction(idx, params, headers) {
            ...
            const deferred = $q.defer();
            let filledArray = [];
            filledArray = config.transformElem(
              filledArray,
              true,
              elemToPut[config.restangularFields.route],
              service
            );
            elemToPut.put(params, headers).then(
              function (serverElem) {
          ...
          function parseResponse(
            ...
            const data = config.responseExtractor(
              resData,
              operation,
              route,
              fetchUrl,
          ...
          function fetchFunction(what, reqParams, headers) {
            ...
            const okCallback = function (response) {
              ...
              let processedData = _.map(data, function (elem) {
            ...
            urlHandler
              ...
              .then(okCallback, function error(response) {
                if (
                  ...
                  _.every(config.errorInterceptors, function (cb) {
          ...
          function save(params, headers) {
            if (this[config.restangularFields.fromServer]) {
              ...
              return _.bind(elemFunction, this)(
                "post",
                undefined,
                params,
                undefined,
          ...
          function elemFunction(operation, what, params, obj, headers) {
            ...
            const etag =
              callObj[config.restangularFields.etag] ||
              (operation !== "post"
                ? this[config.restangularFields.etag]
                : null);
            ...
            let filledObject = {};
            filledObject = config.transformElem(
              filledObject,
              false,
              route,
              service
            ...
            const okCallback = function (response) {
              ...
              if (elem !== null && elem !== undefined && elem !== "") {
                ...
                if (
                  ...
                  data[config.restangularFields.singleOne] =
          ...
          function addRestangularMethodFunction(
            name,
            operation,
            path,
            defaultParams,
          ...
          function withConfigurationFunction(configurer) {
            const newConfig = angular.copy(_.omit(config, "configuration"));
          ...
          function toService(route, parent) {
            const knownCollectionMethods = _.values(config.restangularFields);
            const serv = {};
            ...
            for (const prop in collection) {
              if (
                ...
                !_.includes(knownCollectionMethods, prop)
              ) {
          ...
          service.restangularizeCollection = _.bind(
            restangularizeCollectionAndElements,
            service
          );
